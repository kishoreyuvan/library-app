...
define('library-app/controllers/admin/details', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Controller.extend({
    Users: _ember['default'].computed.oneWay('model'),
    actions: {
...
define('library-app/controllers/secure/list', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Controller.extend({
    actions: {
...
define('library-app/controllers/secure/reserved', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Controller.extend({
    actions: {
...
define('library-app/controllers/signup', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Controller.extend({
    ...
    progress: false,
    success: false,
    isPasswordsEqual: _ember['default'].computed('password', 'confirmpassword', function () {
...
define("library-app/templates/login", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "9XDDaWJu", "block": "{\"symbols\":[],\"statements\":[[4,\"if\",[[20,[\"progress\"]]],null,{\"statements\":[[0,\" \"],[12,\"loading\",[]],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[4,\"if\",[[20,[\"error\"]]],null,{\"statements\":[[0,\" \"],[6,\"div\"],[9,\"class\",\"text-center text-danger\"],[7],[1,[18,\"error\"],false],[8],[0,\"\\n\"]],\"parameters\":[]},null],[6,\"form\"],[9,\"class\",\"form-horizontal outline\"],[3,\"action\",[[19,0,[]],\"login\"],[[\"on\"],[\"submit\"]]],[7],[0,\"\\n  \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n    \"],[6,\"label\"],[9,\"for\",\"inputEmail3\"],[9,\"class\",\"col-sm-5 control-label\"],[7],[0,\"Email\"],[8],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"col-sm-3\"],[7],[0,\"\\n      \"],[1,[25,\"input\",null,[[\"type\",\"class\",\"id\",\"value\"],[\"email\",\"form-control\",\"inputEmail3\",[20,[\"email\"]]]]],false],[0,\"\\n    \"],[8],[0,\"\\n  \"],[8],[0,\"\\n  \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n    \"],[6,\"label\"],[9,\"for\",\"inputPassword3\"],[9,\"class\",\"col-sm-5 control-label\"],[7],[0,\"Password\"],[8],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"col-sm-3\"],[7],[0,\"\\n      \"],[1,[25,\"input\",null,[[\"type\",\"class\",\"id\",\"value\"],[\"password\",\"form-control\",\"inputPassword3\",[20,[\"password\"]]]]],false],[0,\"\\n    \"],[8],[0,\"\\n  \"],[8],[0,\"\\n  \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"col-sm-offset-5 col-sm-10\"],[7],[0,\"\\n      \"],[6,\"button\"],[9,\"type\",\"submit\"],[9,\"class\",\"btn btn-success\"],[7],[0,\"Log in\"],[8],[0,\"\\n      \"],[4,\"link-to\",[\"signup\"],null,{\"statements\":[[6,\"button\"],[9,\"class\",\"btn btn-primary\"],[7],[0,\"Sign Up\"],[8]],\"parameters\":[]},null],[0,\"\\n    \"],[8],[0,\"\\n  \"],[8],[0,\"\\n\"],[8],[0,\"\\n\"]],\"parameters\":[]}]],\"hasEval\":true}", "meta": { "moduleName": "library-app/templates/login.hbs" } });
});
...
if (!runningTests) {
  require("library-app/app")["default"].create({"name":"library-app","version":"0.0.0+78d2d983"});
}
